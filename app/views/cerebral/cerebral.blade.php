...
<div class="row" style="padding-bottom: 20px; padding-top: 25px;">
	@if(!isset($_GET['mode']))
	<div style="text-align: center;"><a href={{ URL::route('cerebral') }} class="btn btn-success btn-lg" style="width: 70%">Hit</a></div>
	@elseif($_GET['mode'] == 'review')
	<div style="text-align: center;"><a href={{ URL::route('cerebral').'?mode=review' }} class="btn btn-success btn-lg" style="width: 70%">Review</a></div>
	@elseif($_GET['mode'] == 'slow')
	<div style="text-align: center;"><a href={{ URL::route('cerebral').'?mode=slow' }} class="btn btn-success btn-lg" style="width: 70%">Slow</a></div>
	@elseif($_GET['mode'] == 'overload')
	<div style="text-align: center;"><a href={{ URL::route('cerebral').'?mode=overload' }} class="btn btn-success btn-lg" style="width: 70%">Overload</a></div>
	@endif
</div>
